...
| `playStoreUserFraction`        | No                | `0.99`      | Percentage of users who should get the staged version of the app. Must be a decimal value greater than 0.0 and less than 1.0                                                                             |
